...
/**
 * <b>inv:</b><br>
 * nombre ≠ null y no vacío.<br>
 * presentacion es BOTELLA o BARRIL.<br>
 * anhoElaboracion > 1000 y ≤ año actual.<br>
 * contenidoAzucar ≥ 0.
 */
public class Vino
{
    ...
    // -------------------------------------------------------------
    /**
     * Verifica la Invariante de la calse vino
     */
    private void verificarInvariante() {
        assert nombre != null && !nombre.isEmpty() : "Nombre no puede ser nulo ni vacío";
        assert presentacion.equals(BARRIL) || presentacion.equals(BOTELLA) : "Presentación inválida";
        assert anhoElaboracion > 1000 && anhoElaboracion <= java.time.Year.now().getValue() : "Año de elaboración inválido";
        assert contenidoAzucar >= 0 : "Contenido de azúcar no puede ser negativo";
    }
    ...
    {
		int resultado = this.presentacion.compareToIgnoreCase(pVino.presentacion);			
    ...
    {
    	int resultado = pVino.presentacion.compareToIgnoreCase(this.presentacion);
        if (resultado == 0)
            return 0;
        else if (resultado > 0)
            return -1;
    ...
    {
    	if (pVino.anhoElaboracion == this.anhoElaboracion)
            return 0;
    ...
    {
    	if (pVino.contenidoAzucar == this.contenidoAzucar)
            return 0;
    ...
    {
    	int resultado = pVino.tipo.compareToIgnoreCase(this.tipo);
        if (resultado == 0)
            return 0;
        else if (resultado > 0)
            return -1;
    ...
    {
    	int resultado = pVino.color.compareToIgnoreCase(this.color);
        if (resultado == 0)
            return 0;
        else if (resultado > 0)
            return -1;
    ...
    {
    	int resultado = pVino.lugarOrigen.compareToIgnoreCase(this.lugarOrigen);
        if (resultado == 0)
            return 0;
        else if (resultado > 0)
            return -1;
